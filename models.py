...
class User(db.Model):
    ...
    def register(cls, username, pwd,email,fname,lname):
        hashed = bc.generate_password_hash(pwd)
    ...
    def auth(cls,username,pwd):
        ...
        if u and bc.check_password_hash(u.password,pwd):
            return u
        else:
            return False
...
class Feedback(db.Model):
    ...
    author = db.relationship('User',backref=db.backref('feedbacks',cascade="all, delete-orphan"))